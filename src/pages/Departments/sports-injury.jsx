...
const doctors = [
  {
    name: "DR. YUGAL VARANDANI",
    degrees: "DNB ORTHO FELLOWSHIP(ARTHROSCOPY & SPORTS INJURY)",
    title: `CONSULTANT ARTHROSCOPY & SPORTS INJURY`,
    hours: "05:30 PM TO 07:30 PM",
  ...
  return (
    <div className="w-full pt-[5vh] gap-10 relative bg-white overflow-hidden flex flex-col items-start justify-start  leading-[normal] tracking-[normal] text-left text-sm text-dimgray-100  mq450:gap-[23px] mq750:gap-[47px]">
      ...
      <div className="text-center sans w-full text-[20px] px-5 container1 mx-auto">
        The Department of Sports Injury is dedicated to helping athletes of all
        levels recover from injuries and return to their peak performance. Our
        team of sports medicine physicians, physical therapists, and athletic
        trainers provide comprehensive care tailored to your specific needs.
      </div>
