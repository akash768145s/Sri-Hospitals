  ...
  return (
    <div className="w-full pt-[5vh] gap-10 relative bg-white overflow-hidden flex flex-col items-start justify-start leading-[normal] tracking-[normal] text-left text-sm text-dimgray-100  mq450:gap-[23px] mq750:gap-[47px]">
      ...
      <div className="text-center sans w-full text-[20px] px-5 container1 mx-auto">
        The Department of General & Laparoscopic Surgery at Sri Hospitals is
        dedicated to offering high-quality surgical care with a focus on
        minimally invasive techniques. We address a wide range of abdominal and
        soft tissue conditions, including appendix removal, hernia repair
        (inguinal, ventral, hiatal), gallbladder removal, colon surgery, thyroid
        and parathyroid surgery, and skin and soft tissue procedures such as
        lump removal and abscess drainage.
      </div>
