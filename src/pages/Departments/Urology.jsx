...
`,
    hours: "12:00 NOON – 01:00 PM",
    degrees: "MBBS., MS., MRCS(EDIN), MCH UROLOGY",
...
const DoctorProfile = ({ name, degrees, title, hours, days, image }) => (
  <div className="flex flex-col items-start justify-between pt-px px-0 pb-[31px] box-border relative gap-[11px] min-w-[263px] max-w-full">
  ...
  return (
    <div className="w-full pt-[5vh] gap-10  relative bg-white overflow-hidden flex flex-col items-start justify-start leading-[normal] tracking-[normal] text-left text-sm text-dimgray-100  mq450:gap-[23px] mq750:gap-[47px]">
      ...
      <div className="text-center sans w-full text-[20px] px-5 container1 mx-auto">
        We have a team of skilled urologists in Chennai dedicated to providing
        comprehensive care for your urinary tract system and men's reproductive
        health. Our services include diagnostic and therapeutic cystoscopy, TURP
        (Transurethral Resection of the Prostate) for BPH (Benign Prostatic
        Hyperplasia), internal urethrotomy for urethral stricture,
        reconstructive surgeries for urethral stricture, ureteroscopy and laser
        lithotripsy for ureteral stones, RIRS (Retrograde Intrarenal Surgery)
        for renal stones, PCNL (Percutaneous Nephrolithotomy) for renal stones,
        urological injuries management, and urinary incontinence surgery for
        women.
      </div>
      ...
      <div className="flex justify-center w-full">
        <section className="w-full flex justify-center pt-0 pb-[77px] max-w-full text-center text-xl text-black  lg:pb-[50px] lg:box-border mq750:pb-8 mq750:box-border">
          <div className="w-[80%] flex flex-wrap max-sm:px-5 justify-center gap-x-9 gap-y-8 container1 mx-auto lg:px-10 md:px-10">
