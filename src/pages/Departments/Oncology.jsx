...
const doctors = [
  {
    name: "DR. K.SIVASUBRAMANIAM",
    degrees: "MD., DM., ECMO(EUROPE)",
    title: `CONSULTANT MEDICAL ONCOLOGIST & RADIATION ONCOLOGIST`,
    hours: "02:00 PM TO 03:00 PM",
  ...
  },
  {
    ...
    degrees:
      "M, DNB (GEN SURG), DNB ( SURG ONCO), MRCS ( EDIN), DSC MED ( SURG GASTRO), DMAS, FMAS",
  ...
  {
    name: "DR. V. ARUN RAMANAN",
    degrees: "MD (RADIOTHERAPY), DM (MEDICAL ONCOLOGY)",
...
const DoctorProfile = ({ name, title, hours, days, image, degrees }) => (
  <div className="flex-1  flex flex-col items-start justify-start  px-0 pb-[31px] box-border relative gap-[11px] min-w-[263px] max-w-full">
...
const Oncology = () => {
  return (
    <div className="w-full pt-[5vh] gap-10 relative bg-white overflow-hidden flex flex-col items-start justify-start leading-[normal] tracking-[normal] text-left text-sm text-dimgray-100  mq450:gap-[23px] mq750:gap-[47px]">
      ...
      <div className="text-center sans w-full text-lg px-5">
        From diagnosis to therapy, Sri’s Department of Oncology stands firmly
        beside you in the fight against cancer. We host some of the best
        oncologists in Chennai, skilled nurses, and support staff. We provide
        surgical oncology, head and neck oncology, oral cavity cancer treatment,
        thoracic oncology, gynecological oncology, gastrointestinal oncology,
        urological oncology services, Breast Cancer and Chemoport Insertion .
      </div>
      <div className="flex justify-center w-full ">
        <section className="w-[80%] flex justify-center pt-0 pb-[77px] max-w-full text-center text-xl text-black  lg:pb-[50px] lg:box-border mq750:pb-8 mq750:box-border">
          <div className="grid grid-cols-1 max-sm:px-5 sm:grid-cols-2 md:grid-cols-3 gap-x-4 gap-y-8  ">
