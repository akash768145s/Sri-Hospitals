...
const doctors = [
  {
    name: "DR. K. THIRUMALVALAVAN",
    degrees: "MBBS., MD (INTERNAL MEDICINE)., D.M (NEPHROLOGY)",
    title: `CONSULTANT INTERNAL MEDICINE & NEPHROLOGIST`,
    hours: "02:00 PM to 05:00 PM",
  ...
  return (
    <div className="w-full pt-[5vh] gap-10 relative bg-white overflow-hidden flex flex-col items-start justify-start leading-[normal] tracking-[normal] text-left text-sm text-dimgray-100  mq450:gap-[23px] mq750:gap-[47px]">
      ...
      <div className="text-center sans w-full text-[20px] px-5 container1 mx-auto">
        Our Nephrology department focuses on the care and treatment of kidney
        disease, offering OP services, in-patient services,Renal, Biopsy
        Dialysis and critical care nephrology.
      </div>
      <div className="flex justify-center w-full ">
        <section className="w-full flex justify-center pt-0 pb-[77px] max-w-full text-center text-xl text-black s lg:pb-[50px] lg:box-border mq750:pb-8 mq750:box-border">
