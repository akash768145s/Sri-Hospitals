...
const doctors = [
  {
    ...
    degrees: "M.D., D.C.H., F.I.A.P.",
    title: `CONSULTANT PEDIATRICIAN
FORMER DIRECTOR ICH – EGMORE
`,
    hours: "10:30 AM TO 2:00 PM & 7:30 PM TO 10:00 PM",
    days: "",
    image: "/doctor-1-1@2x.png",
  },
  {
    name: "DR. MOHANAVEL",
    degrees: "M.S, MCH,F.I.A.P",
    title: `CONSULTANT & PAEDIATRIC SURGEON & PEDIATRIC `,
    hours: "MONDAY – SATURDAY (EXCEPT FRIDAY) ",
    days: "05:00 PM TO 06:00 PM ",
    image: "/doctor-1-1@2x.png",
  },
  {
    name: "DR. SENTHIL GANESH KAMARAJ",
    degrees: "M.S., MCH (PAED SURG), DNB (PAED SURG)",
    title: `CONSULTANT PAEDIATRIC SURGEON & PAEDIATRIC UROLOGY `,
    ...
    <div className="w-full flex flex-row items-start justify-start py-0 px-3.5 box-border max-w-full">
      <div className="flex-1 flex flex-col items-start justify-start gap-[12px] max-w-full">
        ...
        <div className="self-stretch flex flex-col items-center justify-start gap-[12px] text-left text-xl text-steelblue-100">
          ...
          <div className="flex sans flex-row flex-wrap max-sm:flex-col max-md:flex-col w-full max-lg:flex-col items-center justify-center gap-[24px] z-[1] text-center text-sm text-black">
      ...
      <div className="relative w-full h-[247px]">
        ...
        <section className="absolute top-0 right-0 bottom-0 left-0 flex flex-row items-center justify-center text-left text-[38px] text-white ">
          <b className="relative ysabeau max-sm:text-center uppercase z-[1] text-base md:text-lg lg:text-xl xl:text-2xl">
            {`Department of New Born & Pediatric Care`}
          </b>
        </section>
      </div>

      <div className="text-center sans w-full text-[20px] px-5 container1 mx-auto">
        With some of the best pediatric doctors in Chennai, The Department of
        Newborn & Pediatric Care at Sri Hospitals provides comprehensive medical
        care for newborns, infants, and children. Our dedicated pediatricians
        and nurses offer a nurturing environment focused on your child's
        well-being. Our pediatric services include newborn care, immunization,
        preventive care, pediatric surgery, treatment of acute and chronic
        illnesses, and more.
      </div>
...
export default OrthopedicAndTraumaCare;
