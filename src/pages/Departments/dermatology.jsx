...
const doctors = [
  {
    name: "DR. M. ARCHANA",
    degrees: "MBBSS., DDVL",
    title: "CONSULTANT CLINICAL AND COSMETIC DERMATOLOGIST",
...
const Dermatology = () => {
  return (
    <div className="w-full relative bg-white pt-[5vh] gap-10  overflow-hidden flex flex-col items-start justify-start  leading-[normal] tracking-[normal] text-left text-sm text-dimgray-100  mq450:gap-[23px] mq750:gap-[47px]">
      ...
      <div className="text-center sans w-full text-[20px] px-5 container1 mx-auto">
        Our Department of Dermatology is dedicated to helping you achieve and
        maintain healthy, radiant skin. Our board-certified dermatologists are
        experts in diagnosing and treating a wide range of skin, hair, and nail
        conditions. Our specialties include PRP, Manual Mesotherapy for Anti
        Hair Fall, Mesotherapy for Seborrhoeic Dermatitis, Scalp Peel, Chemical
        Peel, Botulinum Toxin Injection, Mesotherapy for Scars, Mesotherapy for
        Brightening and Glow, Skin Tag/Wart Removal, Dermapen/Dermaroller.
      </div>
