...
const doctors = [
  {
    name: "DR. S. PRATHAP KUMAR",
    degrees: "MBBS., MS., MCH.,(VASCULAR SURGERY)",
    title: `CONSULTANT VASCULAR & ENDOVASCULAR SURGEON`,
    hours: "02:00 PM – 03:00 PM",
    days: " MONDAY – FRIDAY",
  ...
  return (
    <div className="w-full pt-[5vh] gap-10  relative bg-white overflow-hidden flex flex-col items-start justify-start leading-[normal] tracking-[normal] text-left text-sm text-dimgray-100  mq450:gap-[23px] mq750:gap-[47px]">
      ...
      <div className="text-center sans  w-full text-[20px] px-5 container1 mx-auto">
        Sri Hospitals is at the forefront of endovascular surgery, utilizing
        advanced catheter-based procedures for faster recovery times and less
        discomfort. Our highly skilled vascular surgeons and endovascular
        specialists provide comprehensive care for a wide range of vascular
        conditions affecting your arteries and veins.
      </div>
