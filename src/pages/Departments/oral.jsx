...
const doctors = [
  {
    name: "DR. S. SHANMUGASUNDARAM",
    degrees: "MDS., FIBOMS., MBA (HOSPITAL MANAGEMENT), FAOCMF (GERMANY)",
    title: `CONSULTANT ORAL & FACIOMAXILLARY SURGEON`,
    hours: "CONSULTATION BY APPOINTMENTS",
    days: "",
    image: "/doctor-1-1@2x.png",
  },
  {
    name: "DR.K.J JAGHANDEEP",
    degrees: "MDS",
    title: `CONSULTANT ORAL & MAXILLOFACIAL SURGEON`,
    hours: "09:00AM TO 11:00PM",
    ...
    <div className="w-full pt-[5vh] gap-10 relative bg-white overflow-hidden flex flex-col items-start justify-start leading-[normal] tracking-[normal] text-left text-sm text-dimgray-100  mq450:gap-[23px] mq750:gap-[47px]">
      ...
      <div className="relative w-full h-[247px]">
        ...
        <section className="absolute top-0 right-0 bottom-0 left-0 flex flex-row items-center justify-center text-left text-[38px] text-white ">
          <b className="relative max-sm:text-center ysabeau uppercase z-[1] text-base md:text-lg lg:text-xl xl:text-2xl">
            {`Department of Oral & Faciomaxillary Surgery`}
          </b>
        </section>
      </div>
      <div className="text-center sans w-full text-[20px] px-5 container1 mx-auto">
        Sri Hospitals’ Department of Oral and Faciomaxillary Surgery offers
        comprehensive treatments, including complex craniofacial fractures and
        soft tissue injuries of the mouth, face, and neck, reconstructive
        surgery involving microvascular free flaps, orthognathic surgery for the
        correction of facial asymmetry, removal of cysts and tumors of the jaws,
