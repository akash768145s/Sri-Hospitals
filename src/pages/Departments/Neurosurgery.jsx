...
const doctors = [
  {
    name: "DR. S. RANGANATHAN JOTHI",
    degrees: "MBBS., MCH (NEURO), DNB (NEUROSURGERY)",
  ...
  {
    name: "DR.K. UDAYADASAN",
    degrees: "MBBS ,MCH",
    title: `CONSULTANT NEUROSURGEON`,
    hours: "02:00PM – 03:00PM",
  ...
  return (
    <div className="w-full pt-[5vh] gap-10 relative bg-white overflow-hidden flex flex-col items-start justify-start leading-[normal] tracking-[normal] text-left text-sm text-dimgray-100  mq450:gap-[23px] mq750:gap-[47px]">
      ...
      <div className="text-center sans w-full text-[20px] px-5 container1 mx-auto">
        The Department of Neurosurgery at Sri Hospitals is your trusted partner
        in safeguarding your central nervous system, including your brain,
        spine, and nerves.
      </div>
