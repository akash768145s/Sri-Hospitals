...
const doctors = [
  {
    name: "DR.A.SIVAKUMAR",
    degrees: "MBBS., MS., MCH. PLASTIC SURGERY",
    title: `CONSULTANT PLASTIC, COSMETIC, HAND & RECONSTRUCTIVE SURGEON`,
    hours: "07:00 AM TO 8:00 AM",
    days: "TUESDAY & FRIDAY",
      ...
      <div className="relative w-full h-[247px]">
        ...
        <section className="absolute top-0 right-0 bottom-0 left-0 flex flex-row items-center justify-center text-left text-[38px] text-white ">
          <b className="relative ysabeau max-sm:text-center uppercase z-[1] text-base md:text-lg lg:text-xl xl:text-2xl">
            {`Department of Cosmetology & Hand Surgery`}
          </b>
        </section>
      </div>

      <div className="text-center w-full sans text-[20px] px-5 container1 mx-auto">
        At Sri Hospitals, we believe beauty goes beyond skin deep. Our
        Department of Cosmetology offers a welcoming environment where our
        licensed professionals help you achieve your desired look and enhance
        your natural beauty. The services we provide include, Reconstruction in
        cancer surgery Reconstruction in diabetic foot Trauma reconstruction,
        Gynecomastia, Otoplasty, Blepharoplasty (Eyelid surgery), Liposuction
        and body contouring, Obesity treatment, Male breast liposuction, Breast
        reduction and uplift, Breast augmentation, Rhinoplasty Fat injection
        Facial scar revision, Hair transplantation.
      </div>
