...
const doctors = [
  {
    name: "DR. SURESH",
    degrees: "MBBS., PGDHS, DIA, DPM",
    title: `CONSULTANT PSYCHIATRIST`,
    hours: "02:00PM – 04:00PM",
  ...
  return (
    <div className="w-full pt-[5vh] gap-10 relative bg-white overflow-hidden flex flex-col items-start justify-start leading-[normal] tracking-[normal] text-left text-sm text-dimgray-100  mq450:gap-[23px] mq750:gap-[47px]">
      ...
      <div className="text-center sans w-full text-[20px] px-5 container1 mx-auto">
        At Sri, we rely on evidence-based assessments to accurately diagnose
        mental health conditions, ensuring you receive the most appropriate
        treatment. We are here to guide you on your journey towards emotional
        wellness.
      </div>
