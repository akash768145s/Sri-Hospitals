...
const doctors = [
  {
    name: "DR.SATHYANARAYANAN",
    degrees: "MBBS, MD, DM",
    title: `ENT, HEAD AND NECK SKULL BASE SURGEON
CONSULTANT ENT & SKULL BASE SURGEON
`,
    hours: "03:00 PM TO 05:00 PM",
    days: "MONDAY TO SATURDAY",
    image: "/doctor-1-1@2x.png",
  },
  {
    name: "DR.NARAYANAN JANAKIRAM",
    degrees: "MBBS, MS(ENT), DLO",
    title: `CONSULTANT ENT & SKULL BASE SURGEON
`,
    ...
    <div className="w-full pt-[5vh] gap-10  relative bg-white overflow-hidden flex flex-col items-start justify-start  leading-[normal] tracking-[normal] text-left text-sm text-dimgray-100  mq450:gap-[23px] mq750:gap-[47px]">
      ...
      <div className="relative w-full h-[247px]">
        ...
        <section className="absolute top-0 right-0 bottom-0 left-0 flex flex-row items-center justify-center text-left text-[38px] text-white ">
          <b className="relative ysabeau text-center uppercase z-[1] text-base md:text-lg lg:text-xl xl:text-2xl">
            {`Department of ENT`}
          </b>
        </section>
      </div>
      <div className="text-center sans w-full text-[20px] px-5 container1 mx-auto">
        Sri-Royal Pearl ENT Centre for Basic to Advanced ENT & Skull-Base
        Surgery brings together a team of highly skilled ENT specialists in
        Chennai dedicated to improving your ear, nose, and throat health. We
        offer comprehensive care for a wide range of conditions, including:
        hearing loss, ear infections, tinnitus, vertigo, swimmer's ear, earwax
        buildup, and balance disorders; sinus infections, allergies, nasal
        polyps, deviated septum, rhinitis, and nosebleeds; tonsillitis, strep
        throat, difficulty swallowing, hoarseness, voice disorders, and sleep
        apnea; and skin cancer, thyroid nodules, and salivary gland disorders in
        the head and neck.
      </div>
